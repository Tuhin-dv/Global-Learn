...
const Nav = () => {
  ...
  return (
      ...
      <div className="bg-gradient-to-t sticky top-0 z-50  from-sky-200 to-purple-200 dark:bg-gradient-to-r dark:from-purple-900 dark:via-indigo-900 dark:to-gray-900 shadow-lg  transition duration-300">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-3">
              ...
              {!user && (
                <NavLink
                  to="/login"
                  className="px-4 py-2 bg-gradient-to-tr from-purple-500 to-blue-400 text-white rounded transition hover:opacity-90"
                >
                  Login
                </NavLink>
              )}
