...
const Home = () => {
  ...
  return (
    <div className="bg-white dark:bg-black/50 text-white transition-colors duration-300">
      <Hero />

      {/* Stats Cards */}
      <div className="max-w-7xl mx-auto px-4 pt-16 pb-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className=" bg-teal-100 hover:bg-teal-200 dark:bg-black/30 text-black dark:text-white p-6 rounded-xl shadow-md flex flex-col items-center text-center  dark:hover:bg-white/10 transition">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {uniqueTutorials.map((tutorial) => (
            <div
              ...
              className="group bg-white/80 dark:bg-gray-800/80  backdrop-blur-sm hover:bg-white dark:hover:bg-gray-800 rounded-2xl cursor-pointer hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 border border-gray-300 border-gray-200/50 dark:border-gray-700/50 overflow-hidden"
            >
              <div className="p-6">
